      ...
      <div className="frame">
        ...
        <div className="reveal grid items-end gap-y-3 md:grid-cols-12 md:gap-x-8">
          ...
          <div className="md:col-span-9">
            ...
            <h2 data-scroll-heading className="display text-display-md flex items-baseline gap-4">
              {t.headingA}
        ...
        <div className="reveal mt-16 grid gap-12 md:grid-cols-12 md:gap-x-8">
          ...
          <aside data-parallax="-0.16" className="order-2 md:order-1 md:col-span-3 space-y-10">
            <div>
